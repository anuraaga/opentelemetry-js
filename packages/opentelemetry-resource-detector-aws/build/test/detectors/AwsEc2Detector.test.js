...
const AWS_HOST = 'http://' + src_1.awsEc2Detector.AWS_IDMS_ENDPOINT;
const AWS_TOKEN_PATH = src_1.awsEc2Detector.AWS_INSTANCE_TOKEN_DOCUMENT_PATH;
const AWS_IDENTITY_PATH = src_1.awsEc2Detector.AWS_INSTANCE_IDENTITY_DOCUMENT_PATH;
const AWS_HOST_PATH = src_1.awsEc2Detector.AWS_INSTANCE_HOST_DOCUMENT_PATH;
const AWS_METADATA_TTL_HEADER = src_1.awsEc2Detector.AWS_METADATA_TTL_HEADER;
const AWS_METADATA_TOKEN_HEADER = src_1.awsEc2Detector.AWS_METADATA_TOKEN_HEADER;
...
describe('awsEc2Detector', () => {
    ...
    describe('with successful request', () => {
        it('should return aws_ec2_instance resource', async () => {
            ...
            const resource = await src_1.awsEc2Detector.detect();
            scope.done();
            assert.ok(resource);
            ...
            resource_assertions_1.assertHostResource(resource, {
                id: 'my-instance-id',
    ...
    describe('with unsuccessful request', () => {
        it('should throw when receiving error response code', async () => {
            ...
            const scope = nock(AWS_HOST)
                ...
                .reply(404, () => new Error());
            try {
                await src_1.awsEc2Detector.detect();
...
//# sourceMappingURL=AwsEc2Detector.test.js.map